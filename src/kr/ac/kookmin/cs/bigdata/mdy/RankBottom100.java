...
public class RankTop100 extends Configured {
	...
	public static void main(String[] args) throws Exception{
		...
		setrank(args[0], args[1], args[2]);
	}
	
	public static void setrank(String inpath, String outpath, String outOther) throws IOException{
		...
		BufferedWriter out = new BufferedWriter(new FileWriter(outOther));
		String s;
		...
		while ((s = in.readLine()) != null) {
			...
			//if (rank > 193){											//not include in Top 100
				//out.write(s);
				//out.newLine();
			//}
